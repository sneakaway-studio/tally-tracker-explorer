...
/**
 *  Early version of DataManager - contains different ways to access JSON data
 */


public class DataManagerOld : Singleton<DataManagerOld> {
    // singleton
    protected DataManagerOld () { }
    public static new DataManagerOld Instance;
